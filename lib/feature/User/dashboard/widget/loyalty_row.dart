...
class LoyaltyRow extends StatelessWidget {
  ...
  final Widget? trailingButton; // 👈 customizable button at the end
            ...
            children: [
              ...
              if (subtitle != null) ...[
                ...
                Text(
                  ...
                  style: TextStyle(
                    fontSize: 14,
                    color: const Color(0xFF9E8A47), // golden color
                    fontFamily: Tfonts.workSansFont,
                  ),
                ),
              ],
